...
%Eh_Segura
eh_segura_antigo(casa(Lin,Col)) :- (Lin=12,Col=1); percorrido(casa(Lin,Col));
(nao_iniW(casa(Lin,Col)), nao_flash(casa(Lin,Col)), nao_poco(casa(Lin,Col)), nao_iniD(casa(Lin,Col))).

eh_segura(casa(Lin,Col)) :- (Lin=12,Col=1); percorrido(casa(Lin,Col));(nao_iniW(casa(Lin,Col)), nao_flash(casa(Lin,Col)), nao_poco(casa(Lin,Col)), nao_iniD(casa(Lin,Col))); 
AdA is Lin + 1, AdB is Lin - 1, AdC is Col + 1, AdD is Col - 1, 
(
(AdA < 12, assert(eh_segura(casa(AdA,Col)));true);
(AdB > 1, assert(eh_segura(casa(AdB, Col)));true);
(AdC < 12, assert(eh_segura(casa(Lin,AdC)));true);
(AdD > 1, assert(eh_segura(casa(Lin, AdD)));true)
).

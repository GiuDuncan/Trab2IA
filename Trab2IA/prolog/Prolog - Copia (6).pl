...
voltado([]).
acoes([]).
eh_safe([casa(12,1), casa(12,2), casa(11,1), casa(8,4), casa(1,1)]).
...
((NovoOuros = 3, voltarg(casa(12,1))); true).
...
(
(AdA is Lin + 1, AdA < 13,((eh_safe(X), member(casa(AdA,Col),X)) -> write("FALHOUa"),nl;(retract(eh_safe(Lista)), assert(eh_safe([casa(AdA,Col)|Lista])),write("Botei A"),nl));true);
(AdB is Lin - 1, AdB > 0, ((eh_safe(X), member(casa(AdB,Col),X)) -> write("FALHOUb"),nl;(retract(eh_safe(Lista)), assert(eh_safe([casa(AdB,Col)|Lista])),write("Botei B"),nl));true);
(AdC is Col + 1, AdC < 13, ((eh_safe(X), member(casa(Lin,AdC),X)) -> write("FALHOUc"),nl;(retract(eh_safe(Lista)), assert(eh_safe([casa(Lin,AdC)|Lista])),write("Botei C"),nl));true);
(AdD is Col - 1, AdD > 0,  ((eh_safe(X), member(casa(Lin,AdD),X))-> write("FALHOUd"),nl;(retract(eh_safe(Lista)), assert(eh_safe([casa(Lin,AdD)|Lista])),write("Botei D"),nl));true)
), false);
